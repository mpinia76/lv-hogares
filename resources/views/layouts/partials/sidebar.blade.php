    ...
    <section class="sidebar">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @can('especialidad-listar')<li><a href="{{ route('especialidads.index') }}"><i class="fa fa-stethoscope"></i>Especialidades</a></li>@endcan
            @can('habitacion-listar')<li><a href="{{ route('habitacions.index') }}"><i class="fa fa-bed"></i>Habitaciones</a></li>@endcan
            @can('medicamento-listar')<li><a href="{{ route('medicamentos.index') }}"><i class="fa fa-capsules"></i>Medicamentos</a></li>@endcan
            @can('mutual-listar')<li><a href="{{ route('mutuals.index') }}"><i class="fa fa-briefcase-medical"></i>Obras Sociales</a></li>@endcan
