                                ...
                                <div class="row">
                                    <div class="col-lg-offset-3 col-lg-6 col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="{{ $familiar->persona->nombre }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-offset-3 col-lg-6 col-md-4">
                                        <div class="form-group">
                                            <label for="apellido">Apellido</label>
                                            <input type="text" class="form-control" id="apellido" name="apellido" placeholder="Nombre" value="{{ $familiar->persona->apellido }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-offset-3 col-lg-6 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="telefono" name="telefono" placeholder="telefono" value="{{ $familiar->persona->telefono }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-offset-3 col-lg-6 col-md-4">
                                        <div class="form-group">
